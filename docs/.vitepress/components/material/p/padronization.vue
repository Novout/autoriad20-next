<template>
  <mainpage>
    <cmpt title="Padronização: Á Moda da Casa">
      <concept title="Requisitos">
        <badge 
          title="Nivelamento: Á Moda da Casa OU Nivelamento: Pontuação Acumulativa" 
          bg="rgba(255,228,209, 1)"
          bg1="rgba(255,228,209, 0.3)"
          bg2="rgba(255,228,209, 0.2)"
          bg3="rgba(255,228,209, 0.1)"
          text="black" 
        />
      </concept>
      <concept title="Tipo">
        <badge 
          title="Padronização" 
          bg="rgba(77,255,158, 1)"
          bg1="rgba(77,255,158, 0.3)"
          bg2="rgba(77,255,158, 0.2)"
          bg3="rgba(77,255,158, 0.1)"
          text="black" 
        />
      </concept>
      <concept title="Categoria">
         <badge 
          title="Padronização Centralizada" 
          bg="rgba(135,116,232, 1)"
          bg1="rgba(135,116,232, 0.3)"
          bg2="rgba(135,116,232, 0.2)"
          bg3="rgba(135,116,232, 0.1)"
          text="black" 
        />
      </concept>
      ...
      <concept title="Impacto">
        <badge 
          title="Muito Alto" 
          bg="rgba(232,116,132, 1)"
          bg1="rgba(232,116,132, 0.3)"
          bg2="rgba(232,116,132, 0.2)"
          bg3="rgba(232,116,132, 0.1)"
          text="black" 
        />
      </concept>
      <lines>
        ...
        <p>Estes atributos podem ter um ou mais valores, onde o jogador na etapa de criação do personagem distribue seu pontos para os recursos de maior importância e impacto para o personagem final.</p>
        <p>Em D&D isto também é chamado de <titalic>Atributo</titalic>, mas deixamos aqui a mecânica de proficiência e perícias como Sub-Agrupamento.</p>
      ...
      <lines>
        ...
        <p>Os modificadores são a base para a gerar recurso, onde a pontuação é distribuida apenas inicialmente.</p>
      ...
      <lines>
        ...
        <p>- Ao utilizar este Sub-Agrupamento com valores inicializados, é recomendado que o personagem inicie com -1.</p>
        <tcontainer :soft="false">
          <h3>Equipamento: Arpão de Tjkat</h3>
          <ul>
      ...
      <lines>
        ...
        <p>- Não é recomendado utilizar com muitos componentes que cedem bônus, pois pode desbalancear totalmente determinadas ações individuais.</p>
        <tcontainer :soft="true">
      ...
      <p><tbold>Problemáticas:</tbold> - Falta de diversidade de conteúdo, pois obriga ao jogador a escolher o recurso que claramente é o melhor para a combinação final de ficha, punindo jogadores caso não siga o padrão.</p>
      <p><tbold>Adaptações:</tbold>- Nada te impede de utilizar o mesmo recurso de D&D, no caso os atributos.</p>
      <tbold>Exemplos:</tbold><tarticle>Chamar o recurso de <titalic>Poderes</titalic>, dividindo por <titalic>Mágico, Físico e Resistência</titalic>, onde o jogador pode distribuir 10 pontos entre os três poderes. Cada ponto em poder determina +1 em rolagens do poder. Outros recursos podem somar ao valor final dos poderes.</tarticle>
    </cmpt>
  </mainpage>
</template>
